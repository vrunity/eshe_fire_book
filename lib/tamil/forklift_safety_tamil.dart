// forklift_safety_tamil.dart

import 'package:e_she_book/book_selection_page.dart';
import 'package:e_she_book/topics/forklift_safety_tamil/forklift_intro.dart';
import 'package:e_she_book/topics/forklift_safety_tamil/center_of_gravity.dart';
import 'package:e_she_book/topics/forklift_safety_tamil/common_accidents.dart';
import 'package:e_she_book/topics/forklift_safety_tamil/general_safety_precautions.dart';
import 'package:e_she_book/topics/forklift_safety_tamil/signals_and_checks.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:e_she_book/welcome.dart';
import 'package:e_she_book/certificate_page.dart';

class ForkliftSafetyTamil extends StatefulWidget {
  @override
  _ForkliftSafetyTamilState createState() => _ForkliftSafetyTamilState();
}

class _ForkliftSafetyTamilState extends State<ForkliftSafetyTamil> {
  Map<String, dynamic> topicProgress = {};
  bool allTopicsCompleted = false;
  String userName = "";

  final List<Map<String, dynamic>> topics = [
    {"title": "தொகுதி 1\nஃபோர்க்லிப்ட் அறிமுகம்", "page": ForkliftIntroTamilPage(), "key": "ForkliftIntro"},
    {"title": "தொகுதி 2\nமைய ஈர்ப்பு & நிலைத்தன்மை", "page": CenterOfGravityTamilPage(), "key": "CenterOfGravity"},
    {"title": "தொகுதி 3\nபொதுவான விபத்துகள்", "page": CommonAccidentsTamilPage(), "key": "ForkliftAccidents"},
    {"title": "தொகுதி 4\nபாதுகாப்பு முன்னெச்சரிக்கைகள்", "page": SafetyPrecautionsTamilPage(), "key": "ForkliftPrecautions"},
    {"title": "தொகுதி 5\nசிறப்புக் குறிகள் & தினசரி சரிபார்ப்புகள்", "page": SignalsAndChecksTamilPage(), "key": "ForkliftSignals"},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("🚧 ஃபோர்க்லிப்ட் பாதுகாப்பு - தமிழ்"),
        leading: IconButton(
          ...
          if (allTopicsCompleted)
            Padding(
              ...
              child: ElevatedButton.icon(
                ...
                label: const Text("சான்றிதழ் பெறு", style: TextStyle(color: Colors.white)),
  ...
  Widget _buildTopicCard(BuildContext context, String title, Widget page, bool isCompleted, int quizScore, String key) {
    ...
    if (quizScore >= 0) {
      ...
      statusText = "✔ முடித்தது";
      statusColor = Colors.blue;
    } else {
      statusText = "🔴 முடியவில்லை";
        ...
        child: ListTile(
          ...
          onTap: isAccessible
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text("முந்தைய தொகுதியை முடிக்கவும் (மதிப்பெண் ≥ 3)")),
            );
          },
        ),
      ),
