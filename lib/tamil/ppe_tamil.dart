...
import 'package:e_she_book/topics/ppe_tamil/eye_protection.dart';
import 'package:e_she_book/topics/ppe_tamil/foot_protection.dart';
import 'package:e_she_book/topics/ppe_tamil/head_protection.dart';
import 'package:e_she_book/topics/ppe_tamil/ppe_into.dart';
import 'package:e_she_book/topics/ppe_tamil/respiratory_protection.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:e_she_book/welcome.dart';

class ppe_tamil extends StatefulWidget {
  @override
  _ppe_tamilState createState() => _ppe_tamilState();
}

class _ppe_tamilState extends State<ppe_tamil> {
  Map<String, dynamic> topicProgress = {};
  bool allTopicsCompleted = false;
  String userName = "";

  final List<Map<String, dynamic>> topics = [
    {"title": "அத்தியாயம்-1\nPPE அறிமுகம்", "page": IntroductionToPPEPage(), "key": "IntroductionToPPE"},
    {"title": "அத்தியாயம்-2\nதலை பாதுகாப்பு", "page": HeadProtectionPage(), "key": "HeadProtection"},
    {"title": "அத்தியாயம்-3\nகண் பாதுகாப்பு", "page": EyeProtectionPage(), "key": "EyeProtection"},
    // {"title": "அத்தியாயம்-4\nகை பாதுகாப்பு", "page": Container(), "key": "HandProtection"},
    {"title": "அத்தியாயம்-4\nமூச்சுக் கோளாறு பாதுகாப்பு", "page": RespiratoryProtectionPage(), "key": "RespiratoryProtection"},
    {"title": "அத்தியாயம்-5\nகால் பாதுகாப்பு", "page": FootProtectionPageTamil(), "key": "FootProtection"},
    // {"title": "அத்தியாயம்-7\nஉடல் பாதுகாப்பு", "page": Container(), "key": "BodyProtection"},
    // {"title": "அத்தியாயம்-8\nவிழும் பாதுகாப்பு", "page": Container(), "key": "FallProtection"},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text('🛡️ PPE வகுப்பு பக்கம்', style: TextStyle(fontWeight: FontWeight.bold)),
        actions: [
          IconButton(
          ...
          if (allTopicsCompleted)
            Padding(
              ...
              child: ElevatedButton.icon(
                ...
                label: const Text("சான்றிதழ் உருவாக்கவும்", style: TextStyle(color: Colors.white)),
        ...
        child: ListTile(
          ...
          onTap: isAccessible
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text("முந்தைய தலைப்பை 4 அல்லது அதற்கு மேற்பட்ட மதிப்பெண்களுடன் முடிக்க வேண்டும்.")),
            );
          },
        ),
      ),
