// kids_safety_tamil.dart

import 'package:e_she_book/book_selection_page.dart';
import 'package:e_she_book/topics/kids_safety_tamil/outdoor_safety.dart';
import 'package:e_she_book/topics/kids_safety_tamil/stranger_safety.dart';
import 'package:e_she_book/topics/kids_safety_tamil/why_kids_safety.dart';
import 'package:e_she_book/topics/kids_safety_tamil/home_safety.dart';
import 'package:e_she_book/topics/kids_safety_tamil/emergency_preparedness.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:e_she_book/welcome.dart';
import 'package:e_she_book/certificate_page.dart';

class KidsSafetyTamil extends StatefulWidget {
  @override
  _KidsSafetyTamilState createState() => _KidsSafetyTamilState();
}

class _KidsSafetyTamilState extends State<KidsSafetyTamil> {
  Map<String, dynamic> topicProgress = {};
  bool allTopicsCompleted = false;
  String userName = "";

  final List<Map<String, dynamic>> topics = [
    {"title": "அத்தியாயம் 1\nகுழந்தை பாதுகாப்பு அறிமுகம்", "page": WhyKidsSafetyTamilPage(), "key": "KidsIntroTamil"},
    {"title": "அத்தியாயம் 2\nஅறிமுகமற்றவர் பாதுகாப்பு விழிப்புணர்வு", "page": StrangerSafetyTamilPage(), "key": "StrangerSafetyTamil"},
    {"title": "அத்தியாயம் 3\nவீட்டு பாதுகாப்பு வழிமுறைகள்", "page": HomeSafetyTamilPage(), "key": "HomeSafetyTamil"},
    {"title": "அத்தியாயம் 4\nவெளிப்புற பாதுகாப்பு குறிப்புகள்", "page": OutdoorSafetyTamilPage(), "key": "OutdoorSafetyTamil"},
    {"title": "அத்தியாயம் 5\nஅவசர நிலைக்கு தயாராகுதல்", "page": EmergencyPreparednessTamilPage(), "key": "EmergencyPreparednessTamil"},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("👶குழந்தை பாதுகாப்பு - தமிழ்"),
        leading: IconButton(
        ...
        child: ListTile(
          ...
          onTap: isAccessible
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text("முந்தைய தலைப்பில் குறைந்தது 3 மதிப்பெண்கள் பெறுங்கள்.")),
            );
          },
        ),
      ),
