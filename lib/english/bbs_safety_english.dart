...
import 'package:e_she_book/topics/bbs_safety_english/bbs_intro.dart';
import 'package:e_she_book/topics/bbs_safety_english/core_principles.dart';
import 'package:e_she_book/topics/bbs_safety_english/observation_process.dart';
import 'package:e_she_book/topics/bbs_safety_english/employee_engagement.dart';
import 'package:e_she_book/topics/bbs_safety_english/incident_prevention.dart';

class BBSSafetyEnglish extends StatefulWidget {
  @override
  _BBSSafetyEnglishState createState() => _BBSSafetyEnglishState();
}

class _BBSSafetyEnglishState extends State<BBSSafetyEnglish> {
  Map<String, dynamic> topicProgress = {};
  bool allTopicsCompleted = false;
  String userName = "";

  final List<Map<String, dynamic>> topics = [
    {"title": "Chapter 1\nIntroduction to BBS", "page": BBSIntroPage(), "key": "BBSIntro"},
    {"title": "Chapter 2\nCore BBS Principles", "page": CorePrinciplesPage(), "key": "CorePrinciples"},
    {"title": "Chapter 3\nObservation Process", "page": ObservationProcessPage(), "key": "ObservationProcess"},
    {"title": "Chapter 4\nEmployee Engagement", "page": EmployeeEngagementPage(), "key": "EmployeeEngagement"},
    {"title": "Chapter 5\nIncident Prevention", "page": IncidentPreventionPage(), "key": "IncidentPrevention"},
  ];
