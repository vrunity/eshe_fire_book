...
import 'package:e_she_book/topics/first_aid_english/bleeding_control.dart';
import 'package:e_she_book/topics/first_aid_english/burn_injuries.dart';
import 'package:e_she_book/topics/first_aid_english/burns_and_scalds.dart';
import 'package:e_she_book/topics/first_aid_english/choking.dart';
import 'package:e_she_book/topics/first_aid_english/crp.dart';
import 'package:e_she_book/topics/first_aid_english/crp_children.dart';
import 'package:e_she_book/topics/first_aid_english/electric_shock.dart';
import 'package:e_she_book/topics/first_aid_english/firstaid_intro.dart';
import 'package:e_she_book/topics/first_aid_english/fractures.dart';
import 'package:e_she_book/topics/first_aid_english/poisoning.dart';

class firstaid_english extends StatefulWidget {
  @override
  _firstaid_englishState createState() => _firstaid_englishState();
}

class _firstaid_englishState extends State<firstaid_english> {
  Map<String, dynamic> topicProgress = {};
  bool allTopicsCompleted = false;
  String userName = "";

  final List<Map<String, dynamic>> topics = [
    {"title": "Chapter-1\nIntroduction To FirstAid", "page": IntroductionToFirstAidPage(), "key": "IntroductionToFirstAid"},
    {"title": "Chapter-2\nBleeding Control", "page": BleedingControlPage(), "key": "BleedingControl"},
    {"title": "Chapter-3\nBurns And Scalds", "page": BurnsAndScaldsPage(), "key": "BurnsAndScalds"},
    {"title": "Chapter-4\nFractures And Sprains", "page": FracturesAndSprainsPage(), "key": "FracturesAndSprains"},
    {"title": "Chapter-5\nElectric Shock", "page": ElectricShockPage(), "key": "ElectricShock"},
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text('📘 First Aid - Class Page', style: TextStyle(fontWeight: FontWeight.bold)),
        leading: IconButton(
