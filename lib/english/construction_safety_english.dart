// construction_safety_english.dart

import 'package:e_she_book/book_selection_page.dart';
import 'package:e_she_book/topics/construction_safety_english/construction_intro.dart';
import 'package:e_she_book/topics/construction_safety_english/electrical_safety.dart';
import 'package:e_she_book/topics/construction_safety_english/personal_protective.dart';
import 'package:e_she_book/topics/construction_safety_english/tools_handling.dart';
import 'package:e_she_book/topics/construction_safety_english/working_at_height.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:e_she_book/welcome.dart';
import 'package:e_she_book/certificate_page.dart';

class ConstructionSafetyEnglish extends StatefulWidget {
  @override
  _ConstructionSafetyEnglishState createState() => _ConstructionSafetyEnglishState();
}

class _ConstructionSafetyEnglishState extends State<ConstructionSafetyEnglish> {
  Map<String, dynamic> topicProgress = {};
  bool allTopicsCompleted = false;
  String userName = "";

  final List<Map<String, dynamic>> topics = [
    {"title": "Chapter 1\nIntroduction to Construction Safety", "page": ConstructionIntroPage(), "key": "ConstructionIntro"},
    {"title": "Chapter 2\nPPE Usage", "page": PersonalProtectivePage(), "key": "PPEUsage"},
    {"title": "Chapter 3\nTool Handling", "page": ToolsHandlingPage(), "key": "ToolsHandling"},
    {"title": "Chapter 4\nWorking at Height", "page": WorkingAtHeightPage(), "key": "WorkingAtHeight"},
    {"title": "Chapter 5\nElectrical Safety", "page": ElectricalSafetyPage(), "key": "ElectricalSafety"},
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("🏗 Construction Safety - English"),
        leading: IconButton(
