// road_safety_english.dart

import 'package:e_she_book/book_selection_page.dart';
import 'package:e_she_book/topics/road_safety_english/emergency_actions.dart';
import 'package:e_she_book/topics/road_safety_english/pedestrian_safety.dart';
import 'package:e_she_book/topics/road_safety_english/road_intro.dart';
import 'package:e_she_book/topics/road_safety_english/traffic_signs.dart';
import 'package:e_she_book/topics/road_safety_english/vehicle_safety.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:e_she_book/welcome.dart';
import 'package:e_she_book/certificate_page.dart';

class RoadSafetyEnglish extends StatefulWidget {
  @override
  _RoadSafetyEnglishState createState() => _RoadSafetyEnglishState();
}

class _RoadSafetyEnglishState extends State<RoadSafetyEnglish> {
  Map<String, dynamic> topicProgress = {};
  bool allTopicsCompleted = false;
  String userName = "";

  final List<Map<String, dynamic>> topics = [
    {"title": "Chapter 1\nIntroduction to Road Safety", "page": RoadIntroPage(), "key": "RoadIntro"},
    {"title": "Chapter 2\nTraffic Signs and Signals", "page": TrafficSignsPage(), "key": "TrafficSigns"},
    {"title": "Chapter 3\nPedestrian Safety", "page": PedestrianSafetyPage(), "key": "PedestrianSafety"},
    {"title": "Chapter 4\nVehicle Safety Tips", "page": VehicleSafetyPage(), "key": "VehicleSafety"},
    {"title": "Chapter 5\nEmergency Actions", "page": EmergencyActionsPage(), "key": "EmergencyActions"},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("🚗 Road Safety - English"),
        leading: IconButton(
