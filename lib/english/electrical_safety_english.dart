// 1. electrical_safety_english.dart

import 'package:e_she_book/book_selection_page.dart';
import 'package:e_she_book/topics/electrical_safety_english/common_hazards.dart';
import 'package:e_she_book/topics/electrical_safety_english/electrical_intro.dart';
import 'package:e_she_book/topics/electrical_safety_english/emergency_procedures.dart';
import 'package:e_she_book/topics/electrical_safety_english/safe_use_equipment.dart';
import 'package:e_she_book/topics/electrical_safety_english/shock_and_firstaid.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:e_she_book/welcome.dart';
import 'package:e_she_book/certificate_page.dart';
// import 'package:e_she_book/topics/electrical_safety/electrical_intro.dart';
// import 'package:e_she_book/topics/electrical_safety/common_hazards.dart';
// import 'package:e_she_book/topics/electrical_safety/shock_and_firstaid.dart';
// import 'package:e_she_book/topics/electrical_safety/safe_use_equipment.dart';
// import 'package:e_she_book/topics/electrical_safety/emergency_procedures.dart';

class ElectricalSafetyEnglish extends StatefulWidget {
  @override
  _ElectricalSafetyEnglishState createState() => _ElectricalSafetyEnglishState();
}

class _ElectricalSafetyEnglishState extends State<ElectricalSafetyEnglish> {
  Map<String, dynamic> topicProgress = {};
  bool allTopicsCompleted = false;
  String userName = "";

  final List<Map<String, dynamic>> topics = [
    {"title": "Chapter 1\nIntroduction to Electrical Safety", "page": ElectricalIntroPage(), "key": "ElectricalIntro"},
    {"title": "Chapter 2\nCommon Electrical Hazards", "page": CommonHazardsPage(), "key": "CommonHazards"},
    {"title": "Chapter 3\nElectrical Shock and First Aid", "page": ShockAndFirstAidPage(), "key": "ShockAndFirstAid"},
    {"title": "Chapter 4\nSafe Use of Electrical Equipment", "page": SafeUseEquipmentPage(), "key": "SafeUseEquipment"},
    {"title": "Chapter 5\nEmergency Procedures", "page": EmergencyProceduresPage(), "key": "EmergencyProcedures"},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("\u26A1 Electrical Safety - English"),
        leading: IconButton(
