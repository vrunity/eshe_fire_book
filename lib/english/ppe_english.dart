...
import 'package:e_she_book/topics/ppe_english/eye_protection.dart';
import 'package:e_she_book/topics/ppe_english/foot_protection.dart';
import 'package:e_she_book/topics/ppe_english/head_protection.dart';
import 'package:e_she_book/topics/ppe_english/ppe_intro.dart';
import 'package:e_she_book/topics/ppe_english/respiratory_protection.dart';
...
class ppe_english extends StatefulWidget {
  @override
  _ppe_englishState createState() => _ppe_englishState();
}

class _ppe_englishState extends State<ppe_english> {
  Map<String, dynamic> topicProgress = {};
  bool allTopicsCompleted = false;
  String userName = "";

  final List<Map<String, dynamic>> topics = [
    {"title": "Chapter-1\nIntroduction to PPE", "page": IntroductionToPPEPage(), "key": "IntroductionToPPE"},
    {"title": "Chapter-2\nHead Protection", "page": HeadProtectionPage(), "key": "HeadProtection"},
    {"title": "Chapter-3\nEye Protection", "page": EyeProtectionPage(), "key": "EyeProtection"},
    {"title": "Chapter-4\nRespiratory Protection", "page": RespiratoryProtectionPage(), "key": "RespiratoryProtection"},
    {"title": "Chapter-5\nFoot Protection", "page": FootProtectionPage(), "key": "FootProtection"},
    // {"title": "Chapter-7\nBody Protection", "page": Container(), "key": "BodyProtection"},
    // {"title": "Chapter-5\nFall Protection", "page": FallProtectionPage(), "key": "FallProtection"},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text('🛡️ PPE - Class Page', style: TextStyle(fontWeight: FontWeight.bold)),
        actions: [
          IconButton(
