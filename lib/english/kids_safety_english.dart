// kids_safety_english.dart

import 'package:e_she_book/book_selection_page.dart';
import 'package:e_she_book/topics/kids_safety_english/outdoor_safety.dart';
import 'package:e_she_book/topics/kids_safety_english/stranger_safety.dart';
import 'package:e_she_book/topics/kids_safety_english/why_kids_safety.dart';
import 'package:e_she_book/topics/kids_safety_english/home_safety.dart';
import 'package:e_she_book/topics/kids_safety_english/emergency_preparedness.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:e_she_book/welcome.dart';
import 'package:e_she_book/certificate_page.dart';

class KidsSafetyEnglish extends StatefulWidget {
  @override
  _KidsSafetyEnglishState createState() => _KidsSafetyEnglishState();
}

class _KidsSafetyEnglishState extends State<KidsSafetyEnglish> {
  Map<String, dynamic> topicProgress = {};
  bool allTopicsCompleted = false;
  String userName = "";

  final List<Map<String, dynamic>> topics = [
    {"title": "Chapter 1\nIntroduction to Kids Safety", "page": WhyKidsSafetyPage(), "key": "KidsIntro"},
    {"title": "Chapter 2\nStranger Safety Awareness", "page": StrangerSafetyPage(), "key": "StrangerSafety"},
    {"title": "Chapter 3\nHome Safety Essentials", "page": HomeSafetyPage(), "key": "HomeSafety"},
    {"title": "Chapter 4\nOutdoor Safety Tips", "page": OutdoorSafetyPage(), "key": "OutdoorSafety"},
    {"title": "Chapter 5\nEmergency Preparedness", "page": EmergencyPreparednessPage(), "key": "EmergencyPreparedness"},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("👶 Kids Safety - English"),
        leading: IconButton(
