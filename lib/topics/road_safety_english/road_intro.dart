        ...
        child: Column(
          children: [
            Expanded(
              child: ListView(
                children: [
                  _buildQuestionAnswer("🚦 What is road safety?", "Road safety involves rules and behaviors to prevent accidents.", imagePath: 'assets/road_1.0.png'),
                  _buildQuestionAnswer("🚦 Why wear a seat belt?", "Seat belts protect you during collisions."),
                  _buildQuestionAnswer("🚦 Pedestrian safety?", "Use footpaths and crossings correctly.", imagePath: 'assets/road_1.1.png'),
                  _buildQuestionAnswer("🚦 Reduce accidents?", "Obey traffic signals, use seat belts."),
                  _buildQuestionAnswer("🚦 Driver safety?", "Stay alert, avoid distractions like phone use.", imagePath: 'assets/road_1.2.png'),
                ],
              ),
            ),
            CheckboxListTile(
