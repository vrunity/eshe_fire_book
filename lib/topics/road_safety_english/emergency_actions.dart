...
class _EmergencyActionsPageState extends State<EmergencyActionsPage> {
  ...
  void _evaluateQuiz() async {
    ...
    if (score >= 3) {
      ...
      print("✅ Course completed date stored for Road Safety: $formattedDate");
    }
        ...
        child: Column(
          children: [
            Expanded(
              child: ListView(
                children: [
                  _buildQuestionAnswer("🚨 What is the first step after an accident?", "Stay calm and assess the situation.", imagePath: 'assets/road_5.0.png'),
                  _buildQuestionAnswer("🚨 What to do with the vehicle?", "Move it to a safe place if possible."),
                  _buildQuestionAnswer("🚨 When to call emergency services?", "Immediately after checking the situation.", imagePath: 'assets/road_5.1.png'),
                  _buildQuestionAnswer("🚨 How to warn other drivers?", "Use hazard lights."),
                  _buildQuestionAnswer("🚨 Providing first aid?", "Only if trained and safe.", imagePath: 'assets/road_5.2.png'),
                ],
              ),
            ),
            CheckboxListTile(
