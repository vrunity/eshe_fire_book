...
// Stateful widget
class ChemicalStoragePage extends StatefulWidget {
  @override
  _ChemicalStoragePageState createState() => _ChemicalStoragePageState();
}

class _ChemicalStoragePageState extends State<ChemicalStoragePage> {
            ...
            if (score >= 3)
              TextButton(
                ...
                onPressed: () {
                  ...
                  Navigator.pushNamed(context, '/chemical_handling_en');
                },
              ),
            TextButton(
              child: Text("Retest"),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Chemical Storage & Labeling"),
