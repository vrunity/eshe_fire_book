...
class ChemicalHandlingPageTamil extends StatefulWidget {
  @override
  _ChemicalHandlingPageTamilState createState() => _ChemicalHandlingPageTamilState();
}

class _ChemicalHandlingPageTamilState extends State<ChemicalHandlingPageTamil> {
            ...
            if (score >= 3)
              TextButton(
                ...
                onPressed: () {
                  ...
                  Navigator.pushNamed(context, '/chemical_emergency_ta');
                },
              ),
            TextButton(
              child: Text("Retest"),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Chemical Handling (Tamil)"),
